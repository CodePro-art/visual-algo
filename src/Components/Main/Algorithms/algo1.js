...
for i in range(len(A)):
    print("%d" %A[i]), `,
    js: `function insertionSort(inputArr) {
...
/* This code is contributed by Rajat Mishra */`,
    python: `# Python program for implementation of MergeSort
def mergeSort(arr):
    if len(arr) > 1:
...
// This code is contributed by Ayush Choudhary`,
    python: `# Python program for implementation of Quicksort Sort
...
#This code in improved by https://github.com/anushkrishnav`,
    js: `function partition(arr, start, end){
